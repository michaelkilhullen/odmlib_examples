...
import os.path
import Study, Standards, Datasets, Variables, ValueLevel, WhereClauses, CodeLists, Dictionaries, Methods, Comments
import Documents, ResultDisplays, AnalysisResults, AnalysisDatasets, ProgrammingCode
...
class Xls2Define:
    ...
    def _load(self, sheet_name, sheet):
        ...
        loader.create_define_objects(sheet, self.define_objects, self.lang, self.acrf, self.suppdocs)
        if sheet_name == "Study":
            self.lang = loader.lang
            self.acrf = loader.acrf
            self.suppdocs = loader.suppdocs
    ...
    def _build_doc(self):
        ...
        odm.Study.MetaDataVersion.AnalysisResultDisplays = self.define_objects["AnalysisResultDisplays"]
        return odm
